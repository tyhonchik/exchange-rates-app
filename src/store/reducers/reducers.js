...
// export function currenciesHasError(state = false, action) {
//     switch (action.type) {
//         case 'CURRENCIES_HAS_ERROR':
//             return action.hasError;
//         default:
//             return state;
//     }
// }
// export function currenciesIsLoading(state = false, action) {
//     switch (action.type) {
//         case 'CURRENCIES_IS_LOADING':
...
//     switch (action.type) {
//         case 'CURRENCIES_FETCH_DATA_SUCCESS':
